  ...
  return (
    ...
    >
      ...
      <div className="rounded-[28px] border border-emerald-300/16 bg-emerald-300/[0.08] p-6 text-sm leading-7 text-white/68">
        ...
        `private_treasury_execution` through the same relay path, and the workbench below lets a visitor build and send
        a real custom_event through the protected read-node without exposing the server key.
