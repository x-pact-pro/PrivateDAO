  ...
  const integrationEvidenceLanes = [
    {
      ...
      summary: "Current Frontier track lane: live corridor PDA check, finalized Testnet private payment receipts, challenge/login private reads, and wallet-signed execution continuity for judges.",
