...
const curatedDocuments: CuratedDocument[] = [
  ...
  },
  {
    ...
    category: "Reviewer core",
    summary: "Compact visual proof packet with real Solscan captures from the current Devnet execution wallet and the encrypted treasury micropayment rail.",
  ...
  },
  {
    ...
    boundary: "Architecture note only; it does not claim a mainnet market token launch or expand token utility beyond the live documented Testnet governance surface.",
  ...
  },
  {
    ...
    category: "Reviewer core",
    summary: "Reviewer-safe Testnet Token-2022 token surface for PDAO governance evidence, including mint details, attested transactions, disabled mint authority, and product-facing interpretation.",
    audience: "Judges, grant reviewers, buyers, operators",
    boundary: "Live Testnet token evidence only; it does not claim a public mainnet token launch or speculative market posture.",
  ...
  },
  {
    ...
    title: "Live Proof V3",
    category: "Reviewer core",
    summary: "Fresh Testnet proof for Governance V3 plus REFHE-settled, MagicBlock-settled, evidence-gated token payout execution.",
    audience: "Judges, reviewers, protocol operators",
    boundary: "Testnet proof only; not a mainnet custody claim.",
  ...
  {
    slug: "testnet-encrypted-integrations-activation-2026-05-23",
    title: "Testnet Encrypted Integrations Activation 2026-05-23",
    category: "Reviewer core",
    summary: "Single activation packet for REFHE, MagicBlock, settlement evidence, token payout execution, IKA SDK readiness, and MagicBlock live probe evidence.",
    audience: "Judges, privacy reviewers, protocol operators",
    boundary: "REFHE and MagicBlock are Solana Testnet settlement gates. IKA is SDK/Sui Testnet readiness plus Solana pre-alpha approval preparation, not a completed dWallet DKG transaction in this packet.",
    docPath: "docs/testnet-encrypted-integrations-activation-2026-05-23.md",
    rawHref: `${repositoryBlobBase}/docs/testnet-encrypted-integrations-activation-2026-05-23.md`,
  },
  {
  ...
  },
  {
    ...
    category: "Security",
    summary: "Deterministic scoring model for how ZK, REFHE, MagicBlock, Hosted reads, and hardening surfaces change the confidence profile of each proposal pattern.",
  ...
  },
  {
    ...
    category: "Reviewer core",
    summary: "Unified packet for ZK anchors, REFHE envelopes, MagicBlock corridor evidence, and Hosted reads-backed runtime surfaces.",
