...
export const READ_NODE_FEATURED_PROPOSAL_CONTEXTS = {
  "payroll": {
    ...
    "sourceLabel": "Backend-indexed proposal record: REFHE confidential payroll envelope 2026-05-07 (Finalized)",
    "indexedPhase": "Finalized",
    "proposalAccount": "4A2qwBvTKYL9kGzjCNHaSCp8jJXcMRaFxPMWf5NJ2qBt",
    ...
    "txContext": {
      "proofStatus": "degraded-testnet-confidential-path",
...
export const READ_NODE_PROPOSAL_REGISTRY = [
  {
    "id": "PDAO-001-2GDR",
    "title": "REFHE confidential payroll envelope 2026-05-07",
    "type": "Enterprise DAO",
  ...
  },
  {
    ...
    "execution": {
      "sourceType": "runtime-indexed",
      "sourceLabel": "Backend-indexed proposal record: Confidential payroll batch / April255552 (Executable)",
      "indexedPhase": "Executable",
      "proposalAccount": "8zFTWHhB8YonTX6FjAfRsWRP45izwBQaj57btAqgdtVi",
      "daoAccount": "CKDqPz4H64U5b66CDrTKAHDuQXV9NwMsKtDjZyUNHhiH",
  ...
  },
  {
    ...
    "execution": {
      "sourceType": "runtime-indexed",
      "sourceLabel": "Backend-indexed proposal record: Confidential payroll batch / April (Executable)",
      "indexedPhase": "Executable",
      "proposalAccount": "FZCdC524iuQ8rb9SsDyX8Uy6oLqvvvi84P7ydLzrtgBV",
      "daoAccount": "2McuCRTgwc96er39sQQnzkzcN94aGWMfR9Rtz64RCdQk",
      "executionTarget": "Execution target remains governed by the indexed proposal account and current DAO phase.",
      "recipient": null,
      "recipientLabel": "Execution target pending index evidence",
      "recipientKnown": false,
  ...
  },
  {
    ...
    "execution": {
      ...
      "sourceLabel": "Backend-indexed proposal record: Governance Hardening V3 live proof (Executed)",
      "indexedPhase": "Executed",
      "proposalAccount": "FcAe9r7ZUVxaFC2YDXydW2qb2uhWopsneh9dL65idxHJ",
      "daoAccount": "C8uVwtCsE24XkMrT63HehZNcMcruS2KSokZq5XYZLdZr",
      "executionTarget": "Send treasury funds to the approved beneficiary after governance finalization and unlock.",
      "recipient": "3tY61SNRGEVDxpDAMfhDjWvtWaFsv4JTPHSV6uQNSA1z",
      "recipientLabel": "Treasury beneficiary",
      "recipientKnown": true,
      "amount": 0.05,
      "amountDisplay": "0.05 SOL",
  ...
  },
  {
    ...
    "execution": {
      ...
      "sourceLabel": "Backend-indexed proposal record: Confidential payroll batch / April (Executable)",
      "indexedPhase": "Executable",
      "proposalAccount": "FcXnwjwSCxER1ensgrFJyXsSTnEVab79p1EuLmxeUn61",
      "daoAccount": "EPzmqAsTTZVW2PwVZZGenaUq7TRqszu8DdzryPaMPXd",
      "executionTarget": "Execution target remains governed by the indexed proposal account and current DAO phase.",
      "recipient": null,
      "recipientLabel": "Execution target pending index evidence",
      "recipientKnown": false,
  ...
  },
  {
    ...
    "execution": {
      ...
      "indexedPhase": "Executed",
      "proposalAccount": "GQq6bQbJ9bmXq3S2gxCBCMFxt7zcTYETHg9zaioYjtRW",
      "daoAccount": "BZsoqAviQbCRPtzGs8qYGrQCGGpYR5VshE9ECY6aqyLr",
      "executionTarget": "Execution target remains governed by the indexed proposal account and current DAO phase.",
      "recipient": null,
      "recipientLabel": "Execution target pending index evidence",
      "recipientKnown": false,
