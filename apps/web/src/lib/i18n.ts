...
export const localizedCopy: Record<SupportedLocale, LocalizedCopy> = {
  ...
  ar: {
    ...
    statusBanner: {
      ...
      title: "PrivateDAO هو نظام تشغيل مالي على Anchor 1 Testnet للحوكمة الخاصة، تنفيذ الخزانة، ذكاء QVAC، والإثبات.",
      body: "المسار الحي يربط الأقسام الرئيسية من أول زيارة: Intelligence وGovern وTreasury وPayroll وGaming وCompliance وProof وDevelopers وRPC Services وCommand Center. المستخدم يرى رحلة محفظة سهلة، بينما يستطيع المدقق أو المستثمر فحص نفس النظام عبر أدلة مباشرة وروابط إثبات وحالة on-chain قابلة للتحقق.",
      retry: "أعد المحاولة بعد دقائق",
      until: "اكتمل نشر Anchor 1 على Testnet؛ ما زال Mainnet الإنتاجي مشروطًا بالأدلة",
  ...
  ru: {
    ...
    statusBanner: {
      label: "Уведомление о live-разработке",
      title: "PrivateDAO — финансовая ОС на Anchor 1 Testnet для приватного управления, treasury execution, QVAC intelligence и proof.",
      body: "Первый визит сразу открывает главные маршруты: Intelligence, Govern, Treasury, Payroll, Gaming, Compliance, Proof, Developers, RPC Services и Command Center. Пользователь действует из кошелька, а ревьюеры и инвесторы проверяют ту же систему через evidence packets и on-chain state.",
      retry: "Повторите через несколько минут",
      until: "Anchor 1 Testnet deployment завершен; production mainnet остается evidence-gated",
      openTrust: "Открыть trust",
  ...
  uk: {
    ...
    statusBanner: {
      label: "Сповіщення про live-розробку",
      title: "PrivateDAO — фінансова ОС на Anchor 1 Testnet для приватного керування, treasury execution, QVAC intelligence і proof.",
      body: "Перший візит одразу відкриває головні маршрути: Intelligence, Govern, Treasury, Payroll, Gaming, Compliance, Proof, Developers, RPC Services і Command Center. Користувач діє з гаманця, а рев'юери та інвестори перевіряють ту саму систему через evidence packets і on-chain state.",
      retry: "Спробуйте ще раз за кілька хвилин",
      until: "Anchor 1 Testnet deployment завершено; production mainnet лишається evidence-gated",
      openTrust: "Відкрити trust",
  ...
  pl: {
    ...
    statusBanner: {
      label: "Powiadomienie o rozwoju live",
      title: "PrivateDAO to finansowy OS na Anchor 1 Testnet dla prywatnego governance, treasury execution, QVAC intelligence i proof.",
      body: "Pierwsza wizyta od razu pokazuje główne trasy: Intelligence, Govern, Treasury, Payroll, Gaming, Compliance, Proof, Developers, RPC Services i Command Center. Użytkownicy działają z portfela, a reviewerzy i inwestorzy sprawdzają ten sam system przez evidence packets i on-chain state.",
      retry: "Spróbuj ponownie za kilka minut",
      until: "Anchor 1 Testnet deployment zakończony; production mainnet pozostaje evidence-gated",
      openTrust: "Otwórz trust",
      openCommunity: "Otwórz społeczność",
    },
  },
  hi: {
    ...englishCopy,
  ...
  es: {
    ...
    statusBanner: {
      label: "Aviso de desarrollo en vivo",
      title: "PrivateDAO es un sistema financiero en Anchor 1 Testnet para gobernanza privada, treasury execution, QVAC intelligence y proof.",
      body: "La primera visita muestra directamente las rutas principales: Intelligence, Govern, Treasury, Payroll, Gaming, Compliance, Proof, Developers, RPC Services y Command Center. El usuario actúa desde la wallet, mientras revisores e inversores inspeccionan el mismo sistema con evidence packets y on-chain state.",
      retry: "Vuelve a intentarlo en unos minutos",
      until: "Anchor 1 Testnet deployment completo; production mainnet sigue evidence-gated",
      openTrust: "Abrir trust",
