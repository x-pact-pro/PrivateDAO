...
assert metrics["metrics"]["quickNodeStream"]["auth"] == "configured", "remote /api/v1/metrics missing QuickNode auth posture"
assert metrics["metrics"]["quickNodeStream"]["statePersistence"] == "runtime-volume", "remote /api/v1/metrics missing QuickNode persistence posture"
assert metrics["metrics"]["quickNodeStream"]["rawPayloadStorage"] == "disabled", "remote /api/v1/metrics raw payload boundary drifted"
