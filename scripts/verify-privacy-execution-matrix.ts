...
function main() {
  ...
  for (const required of [
    ...
    "security-incident-room-request",
    "emergency-governance-request",
    "confidential-grant-review-request",
    "organizational-memory-vault",
    "agent-governance-request",
    "Discuss -> Review -> Approve -> Execute -> Audit",
    ...
    "claimPrepareUrl",
    "claimMemoTemplate",
    "Every visitor creates a fresh AES-GCM encrypted packet",
    "visitorRepeatable",
