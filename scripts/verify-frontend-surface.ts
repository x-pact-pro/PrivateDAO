...
function main() {
  ...
  const checks: Array<[string, string, string]> = [
    ...
    [privacyClaimConsole, "confidential-treasury-request", "claim console is missing confidential treasury requests"],
    [privacyClaimConsole, "metadao-grant-review-workflow", "claim console is missing the PrivateDAO workflow claim id"],
    [privacyClaimConsole, "Market Decision", "claim console is missing the coordination graph"],
    [privacyClaimConsole, "Role-based coordination", "claim console is missing roles"],
    [privacyClaimConsole, "Prove layer", "claim console is missing prove layer"],
    [privacyClaimConsole, "Institutional memory vault", "claim console is missing institutional memory language"],
    [privacyClaimConsole, "security-incident-room-request", "claim console is missing security incident rooms"],
    [privacyClaimConsole, "emergency-governance-request", "claim console is missing emergency governance requests"],
    [privacyClaimConsole, "confidential-grant-review-request", "claim console is missing confidential grant review requests"],
    [privacyClaimConsole, "agent-governance-request", "claim console is missing agent governance requests"],
    [privacyClaimConsole, "Discuss", "claim console is missing the request lifecycle"],
    [privacyClaimConsole, "Audit", "claim console is missing the audit phase"],
    ...
    [integrationClaimMatrix, "Confidential Treasury Request", "integration claim matrix is missing confidential treasury requests"],
    [integrationClaimMatrix, "PrivateDAO Grant Review Workflow", "integration claim matrix is missing PrivateDAO workflow"],
    [integrationClaimMatrix, "Market Decision", "integration claim matrix is missing PrivateDAO native workflow graph"],
    [integrationClaimMatrix, "Prove", "integration claim matrix is missing the prove layer"],
    [integrationClaimMatrix, "Institutional Memory Vault", "integration claim matrix is missing institutional memory language"],
    [integrationClaimMatrix, "Security Incident Room", "integration claim matrix is missing security incident rooms"],
    [integrationClaimMatrix, "Emergency Governance", "integration claim matrix is missing emergency governance"],
    [integrationClaimMatrix, "Confidential Grant Review", "integration claim matrix is missing confidential grant review"],
    [integrationClaimMatrix, "Agent Governance Request", "integration claim matrix is missing agent governance"],
    ...
    [fs.readFileSync(path.resolve("apps/web/src/app/pilots/page.tsx"), "utf8"), "Prove one sensitive organizational workflow in four weeks.", "/pilots is missing the fixed-scope pilot narrative"],
