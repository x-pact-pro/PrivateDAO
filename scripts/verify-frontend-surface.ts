...
function main() {
  ...
  const checks: Array<[string, string, string]> = [
    ...
    [privacyClaimConsole, "metadao-grant-review-workflow", "claim console is missing the MetaDAO workflow"],
    ...
    [integrationClaimMatrix, "MetaDAO Grant Review Workflow", "integration claim matrix is missing MetaDAO workflow"],
    [integrationClaimMatrix, "Market passes", "integration claim matrix is missing MetaDAO native workflow graph"],
